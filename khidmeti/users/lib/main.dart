...
class ChatService {
  ...
  String _currentUserId() {
    return kUseFirebase ? (FirebaseAuth.instance.currentUser?.uid ?? 'user-demo') : 'user-demo';
  }
...
Future<void> _initFcmForUsers() async {
              ...
              Center(
                child: BubbleButton(
                  ...
                  onPressed: () async {
                    ...
                    final usersRepo = UsersRepository(FirebaseFirestore.instance);
                    final user = UserModel(
                      id: uid,
                      name: 'User',
                      email: 'user@example.com',
                      selectedAvatar: selectedAvatar ?? AvatarService().getRandomUserAvatar(),
                      preferences: const {'primaryColor': '#FCDC73', 'accentColor': '#E76268'},
                      createdAt: DateTime.now(),
                    );
                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            final isMe = kUseFirebase
                                ? (m.senderId == (FirebaseAuth.instance.currentUser?.uid ?? 'user-demo'))
                                : (m.senderId == 'user-demo');
                            return Align(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  color: isMe ? kPrimaryYellow : kSurfaceColor,
